...
| Week 4, Tuesday            | January 23| Prompt Tuning, chain of thought, hindsight chain of thought, backwards chain of thought, Graph of Thought, Tree of Thought, prompt engineering |   |
...
| Week 8, Thursday   | February 22| Frontiers, using LLMs to help diffusion models by planning out images. Instance recognition and inserting new objects %s tricks Using LLMs to help diffusion models by planning out images.  
Consistency models SD Edit  Diffusion in robotics.                                      | |
